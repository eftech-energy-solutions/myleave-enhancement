			...
			<div class="card leave-card">
				...
				<div class="leave-stat">
					<div class="leave-label">
						...
						<strong
							>{fmtNum(
								user.annual_balance ?? user.remaining_leave ?? user.leave_entitlement_annual
							)} days</strong
						>
					</div>
					<div class="leave-meta">
						...
						>
						/ Entitlement <b>{fmtNum(user.leave_entitlement_annual_original)}</b>
					</div>
				</div>
				...
				<div class="leave-stat">
					<div class="leave-label">
						...
						<strong>{fmtNum(user.medical_balance ?? user.leave_entitlement_medical)} days</strong>
					</div>
					<div class="leave-meta">
						Balance <b>{fmtNum(user.medical_balance ?? user.leave_entitlement_medical)}</b> /
						Entitlement
						<b>{fmtNum(user.medical_entitlement ?? user.leave_entitlement_medical_original)}</b>
					</div>
				</div>
				...
				<div class="leave-stat">
					<div class="leave-label">
						...
						<strong>{fmtNum(user.hospital_balance ?? user.hosp_balance)} days</strong>
					</div>
					<div class="leave-meta">
						Balance <b>{fmtNum(user.hospital_balance ?? user.hosp_balance)}</b> / Entitlement
						<b>{fmtNum(user.hospital_entitlement ?? user.hosp_entitlement)}</b>
					</div>
				</div>
