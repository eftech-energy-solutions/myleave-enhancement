...
<style>
  ...
  .photo-card .cam{
    width:56px; height:56px; border-radius:9999px; background:#49bdb3;
  ...
  .btn-primary{
    background:#49bdb3; color:#fff; border:none; border-radius:10px; padding:.8rem 1.4rem; font-weight:700; cursor:pointer;
  }
